...
[This](https://drive.google.com/drive/folders/1QLQxg-BjKFzRfSUeOYc8y-AiiP-_GMip?usp=sharing) data-folder on Google Drive contains all the data sets used for training and testing the SVM model. 
